...
<div class="sidebar-widget wow fadeInUp outer-bottom-vs">
			...
			<div class="product-image">
				<div class="image">
					<a href="/template/assets/images/products/s1.jpg" data-lightbox="image-1" data-title="Nunc ullamcors">
						<img data-echo="/template/assets/images/products/s1.jpg" src="/template/assets/images/blank.gif" alt="">
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="/template/assets/images/products/s2.jpg" data-lightbox="image-1" data-title="Nunc ullamcors">
						<img data-echo="/template/assets/images/products/s2.jpg" src="/template/assets/images/blank.gif" alt="">
						<div class="zoom-overlay"></div>
					</a>					
				</div><!-- /.image -->
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="/template/assets/images/products/s3.jpg" data-lightbox="image-1" data-title="Nunc ullamcors">
						<img data-echo="/template/assets/images/products/s3.jpg" src="/template/assets/images/blank.gif" alt="">
						<div class="zoom-overlay"></div>
					</a>					
				</div><!-- /.image -->
