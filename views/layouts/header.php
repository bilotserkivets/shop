...
<html lang="en">
	<head>
	    ...
	    <title>b-shop.com - Unicase</title>
		...
		<div class="header-top-inner">
			<div class="cnt-account">
				<ul class="list-unstyled">
					<li><a href="#"><i class="icon fa fa-user"></i>Мій акаунт</a></li>
					<li><a href="#"><i class="icon fa fa-heart"></i>Список бажань</a></li>
					<li><a href="#"><i class="icon fa fa-shopping-cart"></i>Мій кошик</a></li>
					<li><a href="#"><i class="icon fa fa-key"></i>Перевірити</a></li>
					<li><a href="#"><i class="icon fa fa-sign-in"></i>Логін</a></li>
				</ul>
			</div><!-- /.cnt-account -->
...
<!-- ============================================================= LOGO : END ============================================================= -->				</div><!-- /.logo-holder -->
    ...
    <div class="contact inline">
        <i class="icon fa fa-envelope"></i> saler@b-shop.com
    </div>
</div><!-- /.contact-row -->
<!-- ============================================================= SEARCH AREA ============================================================= -->
<div class="search-area">
    <form>
        <div class="control-group">
            ...
            <ul class="categories-filter animate-dropdown">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu" >
                        <li class="menu-header">Компьютер</li>
            ...
            <input class="search-field" placeholder="Шукати тут..." />
	...
	<div class="nav-outer">
		<ul class="nav navbar-nav">
			<li class="active dropdown yamm-fw">
				<a href="home.html" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Головна</a>
				<ul class="dropdown-menu">
					<li>
...
<!-- ============================================== WIDE PRODUCTS : END ============================================== -->
			...
			<li class="dropdown yamm">
				<a href="home.html" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">Ноутбуки</a>
				<ul class="dropdown-menu">
					<li>
						<div class="yamm-content">
    <div class="row">
        <div class='col-sm-12'>
           <div class="col-xs-12 col-sm-12 col-md-4">
			...
			<li class="dropdown">
				...
				<a href="category.html">Смартфони
				   <span class="menu-label hot-menu hidden-xs">hot</span>
				</a>
			</li>
			<li class="dropdown hidden-sm">
				
				<a href="category.html">Планшети
...
<div class="side-menu animate-dropdown outer-bottom-xs">
    ...
    <nav class="yamm megamenu-horizontal" role="navigation">
        <ul class="nav">
            <li class="dropdown menu-item">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-desktop fa-fw"></i>Ноутбуки</a>
    ...
    <li class="yamm-content">
        <div class="row">
            ...
            <li class="dropdown menu-item">
                 <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-mobile fa-fw"></i>Смартфони</a>
                 <!-- ================================== MEGAMENU VERTICAL ================================== -->
<ul class="dropdown-menu mega-menu">
    <li class="yamm-content">
        <div class="row">
...
<!-- ================================== MEGAMENU VERTICAL ================================== -->            </li><!-- /.menu-item -->
            ...
            <li class="dropdown menu-item">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon fa fa-apple fa-fw"></i>Планшети</a>
                 <ul class="dropdown-menu mega-menu">
    <li class="yamm-content">
        <div class="row">
            <div class="col-sm-12 col-md-3">
                <ul class="links list-unstyled">  
                    <?php foreach($categoryNotepad as $notepad): ?>
                    <li><a href="#"><?php echo $notepad['brand']; ?></a></li>
                    <?php endforeach;?>   
                </ul>
            </div><!-- /.col -->
        </div><!-- /.row -->
...
<!--<div class="sidebar-widget outer-bottom-small wow fadeInUp">
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="/template/assets/images/products/sm1.jpg" data-lightbox="image-1" data-title="Nunc ullamcors">
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="/template/assets/images/products/sm2.jpg" data-lightbox="image-1" data-title="Nunc ullamcors">
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="/template/assets/images/products/sm3.jpg" data-lightbox="image-1" data-title="Nunc ullamcors">
...
<div class="sidebar-widget product-tag wow fadeInUp">
	<h3 class="section-title">Теги продукту</h3>
	<div class="sidebar-widget-body outer-top-xs">
		<div class="tag-list">					
...
<!--<div class="sidebar-widget outer-bottom-small wow fadeInUp">
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="/template/assets/images/products/sm4.jpg" data-lightbox="image-1" data-title="Nunc ullamcors">
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="/template/assets/images/products/sm5.jpg" data-lightbox="image-1" data-title="Nunc ullamcors">
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="/template/assets/images/products/sm6.jpg" data-lightbox="image-1" data-title="Nunc ullamcors">
	...
	<div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-xs">
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="/template/assets/images/hot-deals/1.jpg" alt="">
							</div>
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="/template/assets/images/hot-deals/2.jpg" alt="">
							</div>
							<div class="sale-offer-tag"><span>35%<br>off</span></div>
							<div class="timing-wrapper">
								<div class="box-wrapper">
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="/template/assets/images/hot-deals/3.jpg" alt="">
							</div>
							<div class="sale-offer-tag"><span>35%<br>off</span></div>
							<div class="timing-wrapper">
								<div class="box-wrapper">
