...
<div class="contact-timing">
	...
	<div class="module-body outer-top-xs">
		<div class="table-responsive">
			<table class="table">
				<tbody>
					<tr><td>Понеділок-П'ятниця:</td><td class="pull-right">08.00 To 18.00</td></tr>
					<tr><td>Субота:</td><td class="pull-right">09.00 To 20.00</td></tr>
					<tr><td>Неділя:</td><td class="pull-right">10.00 To 20.00</td></tr>
				</tbody>
			</table>
		</div><!-- /.table-responsive -->
		<p class='contact-number'>Гаряча лінія:(044)888 868 848</p>
	</div><!-- /.module-body -->
</div><!-- /.contact-timing -->
...
<div class="latest-tweet">
	<div class="module-heading">
		<h4 class="module-title">останні публікації</h4>
	</div><!-- /.module-heading -->
...
<div class="contact-information">
	<div class="module-heading">
		<h4 class="module-title">інформація</h4>
	</div><!-- /.module-heading -->
...
<!-- ============================================================= FOOTER : END============================================================= -->
	...
	<script src="/template/switchstylesheet/switchstylesheet.js"></script>
